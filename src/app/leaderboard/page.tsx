              ...
              >
                <div className="col-span-1 flex justify-center">
                  <span className={`flex items-center justify-center w-8 h-8 rounded-full ${
                    ...
                    index === 2 ? 'bg-amber-600 text-amber-100' : 'bg-gray-700 text-gray-300'
                  } font-bold`}>
                    {index + 1}
                  </span>
                </div>
                <div className="col-span-7 flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">{user.level} • {user.score.toLocaleString()} points</div>
                  </div>
                </div>
                <div className="col-span-4 text-right">
                  <div className="font-bold text-emerald-400">{user.score.toLocaleString()}</div>
                </div>
              </div>
            ))}
          </div>
