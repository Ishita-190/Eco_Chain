...
const getActivityIcon = (type: ActivityType) => {
  switch (type) {
    case 'recycle': return <Leaf className="w-4 h-4 text-green-500" />;
    case 'streak': return <Award className="w-4 h-4 text-yellow-500" />;
    case 'challenge': return <Activity className="w-4 h-4 text-purple-500" />;
...
export default function ProfileContent() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setUserData({
        ...
        recentActivity: [
          { id: '1', type: 'recycle', amount: 120, date: '2h ago', points: 120, title: 'Plastic Recycling', description: 'Recycled 120kg of plastic waste' },
          { id: '2', type: 'streak', amount: 3, date: '1d ago', points: 30, title: '3 Day Streak', description: 'Maintained recycling streak for 3 days' },
          { id: '3', type: 'recycle', amount: 85, date: '2d ago', points: 85, title: 'Glass Recycling', description: 'Recycled 85kg of glass' },
        ],
      });
      setIsLoading(false);
    }, 1000);
  ...
  if (!userData) return <div className="min-h-screen flex items-center justify-center">No user data</div>;
