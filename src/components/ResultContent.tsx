...
export default function ResultContent() {
    ...
    try {
      ...
      setFacilities([
        ...
        },
        {
          ...
          operatingHours: { weekdays: '9:00 AM - 5:00 PM', weekends: '10:00 AM - 3:00 PM' },
        ...
        },
        {
          ...
          operatingHours: { weekdays: '7:00 AM - 7:00 PM', weekends: '8:00 AM - 5:00 PM' },
        },
      ]);
    } catch (error) {
  ...
  const handleSchedule = () => {
    if (selectedFacility && classification) {
      router.push(
        `/schedule?facilityId=${selectedFacility.id}&classificationId=${classification.id}`
      );
    }
  };
              ...
              <div className="card p-6">
                ...
                {selectedFacility ? (
                  <div className="space-y-4">
                    ...
                    <button onClick={handleSchedule} className="w-full btn-primary py-3">
                      Schedule Pickup
                    </button>
                  </div>
                ) : (
